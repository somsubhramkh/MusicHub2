    ...
    data-ride="carousel">
      <div class="carousel-inner" style="background:black;" >
        ...
        <div class="item active">
          <img class="img-responsive" src="<c:url value='/resources/images/intl-home-slide-american-elite.jpg' />" >
        ...
        <div class="item">
          ...
          <img  class="img-responsive" src="<c:url value='/resources/images/intl-home-slide-edge.jpg' />"	style="height:350 !important; width:420 !important;">
        ...
        <div class="item">
          <img src="<c:url value='/resources/images/intl-home-slide-paramount-2.jpg' />" style="height:350 !important; width:420 !important;" >
          <div class="carousel-caption">
